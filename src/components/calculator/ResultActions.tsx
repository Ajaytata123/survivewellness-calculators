...
const ResultActions: React.FC<ResultActionsProps> = ({
  ...
  const handleShareResults = async () => {
    try {
      ...
      // Directly open email app - this works on all devices
      const emailSubject = encodeURIComponent(resultsData.title);
      ...
      if (navigator.clipboard && navigator.clipboard.writeText) {
        ...
        showSuccessToast('Results prepared for sharing and copied to clipboard!');
      } else {
        showSuccessToast('Email app opened with your results!');
      }
      
      console.log('Share functionality executed successfully');
    } catch (error) {
