...
export const prepareResultsForCSV = (results: ResultForDownload): string => {
  ...
  // Updated branding message to use consistent Survivewellness name
  csvContent += `\nGenerated by,Survivewellness Health Tools\n`;
  csvContent += `Website,https://survivewellness.com/tools-calculators/\n`; 
...
export const prepareResultsAsText = (results: ResultForDownload): string => {
  ...
  // Updated branding message with correct capitalization
  textContent += `\nGenerated by: Survivewellness\n`;
  textContent += `Website: https://survivewellness.com/tools-calculators/\n`;
  ...
  if (navigator.share) {
    ...
    navigator
      .share({
        ...
        text: textResults,
        url: "https://survivewellness.com/tools-calculators/"
      })
...
export const createShareableLink = (calculatorType: string, params: Record<string, string>): string => {
  // Updated to use the main site URL
  const baseUrl = "https://survivewellness.com/tools-calculators/";
